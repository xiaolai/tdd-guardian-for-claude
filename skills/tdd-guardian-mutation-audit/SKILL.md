---
name: tdd-guardian-mutation-audit
description: Validate test robustness with mutation testing and close surviving mutants when mutation gates are enabled.
---
