---
name: tdd-guardian-policy-core
description: Global TDD governance policy for Codex. Use when work needs plan-first development, behavior-driven test quality, and strict completion gates.
---
