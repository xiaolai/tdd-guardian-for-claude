---
name: tdd-guardian-test-matrix
description: Build a comprehensive test matrix for changed behavior with explicit behavior-first assertion strategy per case.
---
